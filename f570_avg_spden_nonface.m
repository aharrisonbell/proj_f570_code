function [avgfunc semfunc]=f570_avg_spden_nonface(xldata,pointer,hmiconfig,xrange,~)
...
for ff=1:length(pointer),
    ...
    normalizer1=max(graphstructsingle.facesND_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer2=max(graphstructsingle.facesNA_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer3=max(graphstructsingle.facesTD_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer4=max(graphstructsingle.facesTA_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer5=max(graphstructsingle.facesFD_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer6=max(graphstructsingle.facesFA_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer7=max(graphstructsingle.bodyp_avg(1000+epoch2(1):1000+epoch2(2)));
    normalizer8=max(graphstructsingle.objct_avg(1000+epoch2(1):1000+epoch2(2)));

    normalizer=max([normalizer1 normalizer2 normalizer3 normalizer4 normalizer5 normalizer6 normalizer7 normalizer8]);
